...
async fn validate_node_id(db: &SqlitePool, node_id: &str) -> Result<(), AppError> {
...
pub(super) async fn list_webdav_secrets_node(
    state: axum::extract::State<AppState>,
    cookies: Cookies,
...
pub(super) async fn upsert_webdav_secret_node(
    state: axum::extract::State<AppState>,
    cookies: Cookies,
    headers: HeaderMap,
...
pub(super) async fn get_webdav_secret_node(
    state: axum::extract::State<AppState>,
    cookies: Cookies,
    Path((node_id, name)): Path<(String, String)>,
) -> Result<Json<WebdavSecretResponse>, AppError> {
...
pub(super) async fn delete_webdav_secret_node(
    state: axum::extract::State<AppState>,
    cookies: Cookies,
    headers: HeaderMap,
    Path((node_id, name)): Path<(String, String)>,
