const messages = {
  ...
  jobs: {
    ...
    deleteConfirm: 'Delete this job? This also deletes its run history.',
    deleteTitle: 'Delete job',
    deleteHelp: 'Archive stops scheduling but keeps history. Delete permanently removes the job and its run history.',
    deletePermanentlyHelp: 'Delete permanently removes the job and its run history.',
    archiveCascadeLabel: 'Cascade delete snapshots on archive',
    archiveCascadeHelp: 'Queue deletion tasks for snapshots; pinned snapshots are excluded.',
    archived: 'Archived',
    ...
    retention: {
      title: 'Retention',
      help: 'Automatically manage snapshot retention: keep last N / keep last N days. Pinned snapshots are never selected by retention.',
  ...
  settings: {
    ...
    hubRuntimeConfig: {
      ...
      sections: {
        ...
        backupRetention: {
          title: 'Backup retention defaults',
          subtitle: 'Defaults for newly created jobs (no restart required)',
        },
        logging: {
      ...
      fields: {
        ...
        backupRetentionEnabled: 'Enable backup retention defaults',
        backupRetentionEnabledHelp: 'When enabled, new jobs inherit this retention policy (can be overridden per job).',
        ...
        backupRetentionTips: 'Tip: When enabled, set at least one of keep-last or keep-days. Pinned snapshots are never selected by retention.',
  ...
  errors: {
    ...
    retentionRuleRequired: 'When retention is enabled, configure keep-last or keep-days',
    retentionLimitInvalid: 'Delete limits must be > 0',
    previewRetentionFailed: 'Failed to preview retention',
    applyRetentionFailed: 'Failed to apply retention',
