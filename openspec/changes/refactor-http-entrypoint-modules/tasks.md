...
- [ ] 2.1 Identify module boundaries (`agents`, `jobs`, `notifications`, `secrets` entrypoints and exports)
- [ ] 2.2 Move `crates/bastion-http/src/http/{agents,jobs,notifications,secrets}.rs` to the corresponding `*/mod.rs`
