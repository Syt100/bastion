...
- [x] 2.1 Identify module boundaries (`cron`, `scheduler`, `storage`, `sync`, entrypoint exports)
- [x] 2.2 Move `crates/bastion/src/agent_client/offline.rs` to `crates/bastion/src/agent_client/offline/mod.rs`
