...
## 2. Backend (API)
- [ ] 2.1 Add `GET /api/dashboard/overview` route and handler
- [ ] 2.2 Implement aggregation queries (stats, 7-day trend, recent runs)
- [ ] 2.3 Add `bastion-http` tests for auth + response shape
...
## 4. Validation
- [ ] 4.1 Run `cargo test -p bastion-http`
