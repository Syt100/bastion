...
- [ ] 2.1 Add new route for `/n/:nodeId/jobs/:jobId`
- [ ] 2.2 Implement Job Detail view:
...
- [ ] 2.3 Simplify Jobs list actions and add “Open” entry point

## 3. Tests / Validation
- [ ] 3.1 Add/update unit tests for routing + Jobs list changes
