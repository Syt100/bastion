...
- [x] 2.1 Identify module boundaries (`enqueue`, `loop`, `send`, `template`, entrypoint exports)
- [x] 2.2 Move `crates/bastion-engine/src/notifications.rs` to `crates/bastion-engine/src/notifications/mod.rs`
