...
## 2. Web UI - FS Picker
- [x] 2.1 Implement clearer empty state rendering (empty directory vs no matches)
- [x] 2.2 Implement clearer error state rendering + contextual actions (retry/up/copy path/clear filters)
- [x] 2.3 Persist per-node filter state in localStorage and restore on open
- [x] 2.4 Add/adjust unit tests (as feasible)
