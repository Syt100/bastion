...
- [x] 2.1 Identify duplicated logic across hub/node WebDAV secret handlers
- [x] 2.2 Extract shared helpers (validation, list/get/delete/upsert wiring, snapshot notify)
