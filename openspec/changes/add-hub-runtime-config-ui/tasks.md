...
## 3. Web UI
- [x] 3.1 Add store + API wiring
- [x] 3.2 Add Settings page (restart banner + read-only + editable fields)
- [x] 3.3 Add i18n strings and route/navigation entry
...
- [x] 5.3 Commit Web UI changes (detailed message)
