...
- [ ] 2.1 Identify duplicated request setup patterns in WebDAV client methods
- [ ] 2.2 Extract shared authenticated request builder helper and reuse across methods
