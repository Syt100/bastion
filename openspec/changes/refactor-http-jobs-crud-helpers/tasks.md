...
- [x] 2.1 Identify duplicated validation/normalization logic in jobs CRUD handlers
- [x] 2.2 Extract shared helpers (name, schedule, agent validation, cron validation, snapshot notify)
